...
import { MoreVert, Info, CheckCircle, Cancel, Delete } from '@mui/icons-material';

const PendingProductsRow = ({ row, columns, key = 0, handleTableAction, selected, handleSelect }) => {
...
export default PendingProductsRow;
