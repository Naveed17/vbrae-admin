...
import { MoreVert, Info, AddCircle, Edit, Delete, DeleteForever } from '@mui/icons-material';

const ProductsRow = ({ row, columns, key = 0, handleTableAction, selected, handleSelect }) => {
                    ...
                    value = (
                        <>
                            ...
                            <Menu anchorEl={anchorEl} open={open} onClose={handleClose}>
                                ...
                                <MenuItem onClick={() => handleAction('add_featured')}>
                                    <AddCircle sx={{ mr: 1, fontSize: 18 }} />
                                    Add to Featured
                                </MenuItem>
                                <MenuItem onClick={() => handleAction('add_special_offers')}>
                                    <AddCircle sx={{ mr: 1, fontSize: 18 }} />
                                    Add to Special Offers
                                </MenuItem>
                                <MenuItem onClick={() => handleAction('add_fee')}>
                                    <AddCircle sx={{ mr: 1, fontSize: 18 }} />
                                    Add Fee
                                </MenuItem>
