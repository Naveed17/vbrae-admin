...
import { MoreVert, Info, Edit, Delete, DeleteForever } from '@mui/icons-material';

const FeaturedProductsRow = ({ row, columns, key = 0, handleTableAction, selected, handleSelect }) => {
                ...
                if (column.id === 'checkbox') {
                    ...
                    value = (
                        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                            {row.product?.badge && (
                                <Chip label={row.product.badge} size="small" color="success" />
                            )}
                            <Image
                    ...
                    value = (
                        <>
                            ...
                            <Menu anchorEl={anchorEl} open={open} onClose={handleClose}>
                                ...
                                <MenuItem onClick={() => handleAction('remove_featured')}>
