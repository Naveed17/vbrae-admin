...
import { MoreVert, Delete, Check } from '@mui/icons-material';

const BlogCommentsRow = ({ row, columns, key = 0, handleTableAction, selected, handleSelect }) => {
...
export default BlogCommentsRow;
