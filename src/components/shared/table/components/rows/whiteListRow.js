...
import { MoreVert as MoreVertIcon, Delete as DeleteIcon, CheckCircle as CheckCircleIcon } from '@mui/icons-material';

const WhiteListRow = ({ row, columns, key = 0, handleTableAction }) => {
                    ...
                    value = (
                        <Box>
                            ...
                            <Menu anchorEl={anchorEl} open={Boolean(anchorEl)} onClose={handleMenuClose}>
                                <MenuItem onClick={() => { handleTableAction({ action: 'disable', data: row }); handleMenuClose(); }}>
                                    <CheckCircleIcon sx={{ mr: 1, fontSize: 18 }} /> Disable
                                </MenuItem>
