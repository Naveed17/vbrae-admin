...
import { TableCell, TableRow, Menu, MenuItem, IconButton, Link } from '@mui/material';
import { MoreVert, Delete, Visibility } from '@mui/icons-material';

const AbuseReportsRow = ({ row, columns, key = 0, handleTableAction }) => {
...
export default AbuseReportsRow;
