...
function ExpiredProductsPageWrapper() {
    ...
    const handleTableActions = (prop) => {
        ...
        if (action === 'view_details') {
            ...
            console.log('Reactivate product:', data);
...
export default ExpiredProductsPageWrapper;
