...
const rows = [
    {
        ...
        checkbox: false,
        product: {
            title: 'Prison Architect - Future Tech Pack DLC Steam CD Key Global',
            image: 'https://cdn.vbrae.com/images/uploads/images/202303/473460a5f2d4db7a9a90b2689c69169780852.jpg',
            url: 'https://vbrae.com/prison-architect-future-tech-pack'
        },
        product_type: 'Digital',
        category: 'CHEAP STEAM KEYS',
        user: { name: 'Freaky', url: 'https://vbrae.com/profile/freaky' },
        date: '2023-03-23 / 17:07',
    },
];

function DraftsPageWrapper() {
