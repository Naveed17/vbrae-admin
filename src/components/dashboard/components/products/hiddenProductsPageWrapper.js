...
const rows = [
    {
        ...
        kyc: 'Enabled',
        page_views: 45,
        date: '2025-12-01 / 08:20',
    },
];

function HiddenProductsPageWrapper() {
    ...
    const handleTableActions = (prop) => {
        ...
        if (action === 'view_details') {
            ...
            console.log('Unhide product:', data);
    ...
    return (
        <Container maxWidth={false}>
            <Card>
                <CardHeader title="Hidden Products" />
...
export default HiddenProductsPageWrapper;
