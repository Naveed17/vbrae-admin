...
const rows = [
    {
        id: '17012',
        user: { name: 'Coşkun Boz', avatar: 'https://vbrae.com/uploads/profile/avatar_693f76eec50b78-49293988-30911145.webp' },
        email: { address: 'coskunboz91@gmail.com', status: 'Confirmed' },
...
function MembersPageWrapper() {
    ...
    return (
        <Container maxWidth={false}>
            <Card>
                <CardHeader title="Members" sx={{ borderBottom: 1, borderColor: 'divider', pb: 2 }} />
                ...
                <CardContent sx={{ p: 3 }}>
                    <EnhanceTable handleTableAction={handleTableActions} rows={rows} from="members" columns={columns} />
                </CardContent>
            </Card>
